...
public class Display extends CalculosCalculosos {
    JFrame d = new JFrame();
    JTextField zTextSubstat1;
    JTextField zTextSubstat2;
    JTextField zTextSubstat3;
    JTextField zTextSubstat4;
    JComboBox tnivel;
    JComboBox tmainStat;
    JComboBox tSubstat1Tipo;
    JComboBox tSubstat1Valor;
    JComboBox tSubstat2Tipo;
    JComboBox tSubstat2Valor;
    JComboBox tSubstat3Tipo;
    JComboBox tSubstat3Valor;
    JComboBox tSubstat4Tipo;
    JComboBox tSubstat4Valor;
    JLabel picLabel;
    JLabel nivel;
    JLabel mainStat;
    JLabel substat1;
    ...
    private void addOpcionTipoJComboBox(JComboBox box) {
        box.addItem("Stat");
        box.addItem("Def");
    ...
    private void addOpcionValorJComboBox(final JComboBox box, JComboBox combo) {
    ...
    public Display() {
        ...
        this.substat4 = new JLabel("4� SubStat");
                ...
                if (evt.getStateChange() == 1) {
                    ...
                    for (i = 0; i < Display.this.boton4.getActionListeners().length; ++i) {
                        if (Display.this.boton4.getActionListeners().length > 0) {
                            Display.this.boton4.removeActionListener(Display.this.boton4.getActionListeners()[0]);
                        }
                    }

                    for (i = 0; i < Display.this.boton8.getActionListeners().length; ++i) {
                        if (Display.this.boton8.getActionListeners().length > 0) {
                            Display.this.boton8.removeActionListener(Display.this.boton8.getActionListeners()[0]);
                        }
                    }

                    for (i = 0; i < Display.this.boton12.getActionListeners().length; ++i) {
                        if (Display.this.boton12.getActionListeners().length > 0) {
                            Display.this.boton12.removeActionListener(Display.this.boton12.getActionListeners()[0]);
                        }
                    }

                    for (i = 0; i < Display.this.boton16.getActionListeners().length; ++i) {
                        if (Display.this.boton16.getActionListeners().length > 0) {
                            Display.this.boton16.removeActionListener(Display.this.boton16.getActionListeners()[0]);
                        }
                    }
                    ...
                    switch (Display.this.Tipo) {
                        ...
                        case "1":
                            ...
                            Display.this.boton4.addActionListener(new ActionListener() {
                                public void actionPerformed(ActionEvent e) {
                                    if (e.getSource().equals(Display.this.boton4) && Display.this.Tipo.equals("1")) {
                                        if ((Display.this.tSubstat1Tipo.getSelectedItem().toString().equals("Stat")
                                                || Display.this.tSubstat2Tipo.getSelectedItem().toString()
                                                        .equals("Stat")
                                                || Display.this.tSubstat3Tipo.getSelectedItem().toString()
                                                        .equals("Stat"))
                                                && !Display.this.mostrado) {
                                            JOptionPane.showMessageDialog((Component) null, "Valor de Stats vacias ");
                                            Display.this.mostrado = false;
                                        } else {
                                            String amainStat = Display.this.tmainStat.getSelectedItem().toString();
                                            StatArtefacto aSubstat1 = new StatArtefacto(
                                                    Display.this.tSubstat1Tipo.getSelectedItem().toString(),
                                                    (Double) Display.this.tSubstat1Valor.getSelectedItem());
                                            StatArtefacto aSubstat2 = new StatArtefacto(
                                                    Display.this.tSubstat2Tipo.getSelectedItem().toString(),
                                                    (Double) Display.this.tSubstat2Valor.getSelectedItem());
                                            StatArtefacto aSubstat3 = new StatArtefacto(
                                                    Display.this.tSubstat3Tipo.getSelectedItem().toString(),
                                                    (Double) Display.this.tSubstat3Valor.getSelectedItem());
                                            StatArtefacto aSubstat4 = null;
                                            if (!Display.this.tSubstat4Tipo.getSelectedItem().toString()
                                                    .equals("Stat")) {
                                                aSubstat4 = new StatArtefacto(
                                                        Display.this.tSubstat4Tipo.getSelectedItem().toString(),
                                                        (Double) Display.this.tSubstat4Valor.getSelectedItem());
                                            }

                                            Artefacto artefacto = new Artefacto(Integer.parseInt(Display.this.Tipo),
                                                    amainStat, aSubstat1, aSubstat2, aSubstat3, aSubstat4);
                                            artefacto = CalculosCalculosos.StatNivel4(artefacto);
                                            Display.this.fnivel.setText("Nivel");
                                            Display.this.fmainStat.setText("Main Stat");
                                            Display.this.fSubstat1.setText("" + artefacto.Substat1.tipo);
                                            Display.this.fSubstat2.setText("" + artefacto.Substat2.tipo);
                                            Display.this.fSubstat3.setText("" + artefacto.Substat3.tipo);
                                            Display.this.fSubstat4.setText("" + artefacto.Substat4.tipo);
                                            Display.this.vnivel.setText("" + artefacto.nivel);
                                            Display.this.vmainStat.setText("" + artefacto.mainStat);
                                            Display.this.vSubstat1.setText("" + artefacto.Substat1.valor);
                                            Display.this.vSubstat2.setText("" + artefacto.Substat2.valor);
                                            Display.this.vSubstat3.setText("" + artefacto.Substat3.valor);
                                            Display.this.vSubstat4.setText("" + artefacto.Substat4.valor);
                                        }
                                    }
                                ...
                                public void actionPerformed(ActionEvent e) {
                                    if (e.getSource().equals(Display.this.boton8)) {
                                        if (!Display.this.tSubstat1Tipo.getSelectedItem().toString().equals("Stat")
                                            ...
                                            Artefacto artefacto = new Artefacto(Integer.parseInt(Display.this.Tipo),
                                                    amainStat, aSubstat1, aSubstat2, aSubstat3, aSubstat4);
                                            artefacto = CalculosCalculosos.StatNivel8(artefacto);
                                            Display.this.fnivel.setText("Nivel");
                                            Display.this.fmainStat.setText("Main Stat");
                                            Display.this.fSubstat1.setText("" + artefacto.Substat1.tipo);
                                            Display.this.fSubstat2.setText("" + artefacto.Substat2.tipo);
                            ...
                            Display.this.boton12.addActionListener(new ActionListener() {
                                public void actionPerformed(ActionEvent e) {
                                    if (e.getSource().equals(Display.this.boton12)) {
                                        if (!Display.this.tSubstat1Tipo.getSelectedItem().toString().equals("Stat")
                                                && !Display.this.tSubstat2Tipo.getSelectedItem().toString()
                                                        .equals("Stat")
                                                && !Display.this.tSubstat3Tipo.getSelectedItem().toString()
                                            ...
                                            Artefacto artefacto = new Artefacto(Integer.parseInt(Display.this.Tipo),
                                                    amainStat, aSubstat1, aSubstat2, aSubstat3, aSubstat4);
                                            artefacto = CalculosCalculosos.StatNivel12(artefacto);
                                            Display.this.fnivel.setText("Nivel");
                                            Display.this.fmainStat.setText("Main Stat");
                                            Display.this.fSubstat1.setText("" + artefacto.Substat1.tipo);
                                            Display.this.fSubstat2.setText("" + artefacto.Substat2.tipo);
                            ...
                            Display.this.boton16.addActionListener(new ActionListener() {
                                public void actionPerformed(ActionEvent e) {
                                    if (e.getSource().equals(Display.this.boton16)) {
                                        if (!Display.this.tSubstat1Tipo.getSelectedItem().toString().equals("Stat")
                                                && !Display.this.tSubstat2Tipo.getSelectedItem().toString()
                                                        .equals("Stat")
                                                && !Display.this.tSubstat3Tipo.getSelectedItem().toString()
                                            ...
                                            Artefacto artefacto = new Artefacto(Integer.parseInt(Display.this.Tipo),
                                                    amainStat, aSubstat1, aSubstat2, aSubstat3, aSubstat4);
                                            artefacto = CalculosCalculosos.StatNivel16(artefacto);
                                            Display.this.fnivel.setText("Nivel");
                                            Display.this.fmainStat.setText("Main Stat");
                                            Display.this.fSubstat1.setText("" + artefacto.Substat1.tipo);
                                            Display.this.fSubstat2.setText("" + artefacto.Substat2.tipo);
                            ...
                            Display.this.boton20.addActionListener(new ActionListener() {
                                public void actionPerformed(ActionEvent e) {
                                    if (e.getSource().equals(Display.this.boton20)) {
                                        if (!Display.this.tSubstat1Tipo.getSelectedItem().toString().equals("Stat")
                                                && !Display.this.tSubstat2Tipo.getSelectedItem().toString()
                                                        .equals("Stat")
                                                && !Display.this.tSubstat3Tipo.getSelectedItem().toString()
                                            ...
                                            Artefacto artefacto = new Artefacto(Integer.parseInt(Display.this.Tipo),
                                                    amainStat, aSubstat1, aSubstat2, aSubstat3, aSubstat4);
                                            artefacto = CalculosCalculosos.StatNivel20(artefacto);
                                            Display.this.fnivel.setText("Nivel");
                                            Display.this.fmainStat.setText("Main Stat");
                                            Display.this.fSubstat1.setText("" + artefacto.Substat1.tipo);
                                            Display.this.fSubstat2.setText("" + artefacto.Substat2.tipo);
                        ...
                        case "4":
                                ...
                                public void actionPerformed(ActionEvent e) {
                                    if (e.getSource().equals(Display.this.boton4)) {
                                        if (!Display.this.tSubstat1Tipo.getSelectedItem().toString().equals("Stat")
                                            ...
                                            StatArtefacto aSubstat1 = new StatArtefacto(
                                                    Display.this.tSubstat1Tipo.getSelectedItem().toString(),
                                                    Double.parseDouble(Display.this.zTextSubstat1.getText()));
                                            StatArtefacto aSubstat2 = new StatArtefacto(
                                                    Display.this.tSubstat2Tipo.getSelectedItem().toString(),
                                                    Double.parseDouble(Display.this.zTextSubstat2.getText()));
                                            StatArtefacto aSubstat3 = new StatArtefacto(
                                                    Display.this.tSubstat3Tipo.getSelectedItem().toString(),
                                                    Double.parseDouble(Display.this.zTextSubstat3.getText()));
                                            StatArtefacto aSubstat4 = null;
                                            if (!Display.this.tSubstat4Tipo.getSelectedItem().toString()
                                                    .equals("Stat")) {
                                                aSubstat4 = new StatArtefacto(
                                                        Display.this.tSubstat4Tipo.getSelectedItem().toString(),
                                                        Double.parseDouble(Display.this.zTextSubstat4.getText()));
                                            }
                            ...
                            Display.this.boton12.addActionListener(new ActionListener() {
                                public void actionPerformed(ActionEvent e) {
                                    if (!Display.this.tSubstat1Tipo.getSelectedItem().toString().equals("Stat")
                                            && !Display.this.tSubstat2Tipo.getSelectedItem().toString().equals("Stat")
                                            && !Display.this.tSubstat3Tipo.getSelectedItem().toString().equals("Stat")
                                            && !Display.this.tSubstat4Tipo.getSelectedItem().toString()
                                                    .equals("Stat")) {
                                        String amainStat = Display.this.tmainStat.getSelectedItem().toString();
                                        StatArtefacto aSubstat1 = new StatArtefacto(
                                        ...
                                        StatArtefacto aSubstat3 = new StatArtefacto(
                                                ...
                                                Double.parseDouble(Display.this.zTextSubstat3.getText()));
                                        StatArtefacto aSubstat4 = null;
                                        if (!Display.this.tSubstat4Tipo.getSelectedItem().toString().equals("Stat")) {
                                            aSubstat4 = new StatArtefacto(
                                                    Display.this.tSubstat4Tipo.getSelectedItem().toString(),
                                                    Double.parseDouble(Display.this.zTextSubstat4.getText()));
                                        }
